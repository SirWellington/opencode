...
When you open the web interface in a browser, you'll see a sign-in page. Check "Remember me" to stay signed in for 30 days, otherwise the session ends when you close the browser.
